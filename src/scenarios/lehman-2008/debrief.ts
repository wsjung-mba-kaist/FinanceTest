...
export const lehmanDebrief: DebriefSpec = {
  historical: {
    ...
    timeline: [
      ...
      {
        turnId: 't3',
        note: '9/12(금) JPM 2차 담보 콜 $5B 현금 이행[VERIFY]; 즉시 현금화 가능 자산 <$2B(Examiner). 18:00 뉴욕연준 소집, "공적 자금 없음". BofA·바클레이스 실사.',
  ...
  expert: {
    ...
    caveats: [
      ...
      '뉴버거버먼의 2일 종결($7B)은 양식화다. 실제 파산 전 제안가 ≈$7B는 언론 보도[VERIFY]이고, 파산 후 매각가 $2.15B만 1차 출처다.',
