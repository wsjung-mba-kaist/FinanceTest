...
export const LEHMAN_SOURCES: Source[] = [
  ...
  },
  {
    ...
    note: '유동성 풀에 JPM 담보 ≈$5.5B·씨티 comfort deposit $2B 포함(비공시); JPM 추가 담보 요구($5B, 6월·9월); 9/12(금) 즉시 현금화 가능 자산 <$2B; 9/10 "약 $41B" 공표',
  },
  {
  ...
  },
  {
    ...
    date: '2008-09-14',
    kind: 'press',
    note: '뉴버거버먼/IMD 매각가 앵커 $7B(파산 전 제안)·$5B(중순 입찰) [VERIFY]; 최종 $2.15B는 8-K 9/29(1차)',
  },
]
