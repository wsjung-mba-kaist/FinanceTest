  ...
  meta: {
    ...
    learningObjectives: [
      ...
      },
      {
        ...
        competency: 'policy',
        decisionIds: ['t4-d2', 't5-d2', 't7-d2', 't8-d2'],
      },
      {
        id: 'lo4',
...
- **감독 단계 R0~R4**: 강화 모니터링(일일 보고) → 제한(자본확충 계획 요구) → 정리 준비(현장 검사) → 명령. 매입확약 불이행은 계약 위반으로 제재·소송 대상이다.`,
    ...
    simplificationNotes: [
      ...
      '증권사 콜차입 한도 자기자본 15%(2015 콜시장 개편)는 규정 원문을 확인하지 못해 VERIFY로 남겼다.',
      ...
      '일별 CP91 값 중 9/28·10/5·10/14·10/21·10/24·11/1·11/24는 확인된 앵커(9/22 3.15%, 11/7 4.92%, 11/25 5.50%, 12/1 5.54%) 사이의 보간이며 VERIFY로 남겼다.',
    ],
    disclaimer:
  ...
  gameOver: [
    ...
    },
    {
      ...
      failed: true,
      ruleText: '결제일(턴 시작) 시점에 현금이 음수이면 지급불능으로 종료됩니다.',
    },
    {
      id: 'insolvent_final',
  ...
  endings: [
    {
      ...
      title: '연착륙 — 차환의 벽을 넘다',
      narrative:
        '12월 15일 강원도가 2,050억을 상환한 날, 한빛증권의 연말 결산 전망은 NCR 150% 이상·유동성비율 100% 이상이며, 11월의 만기 벽을 지나는 동안에도 NCR은 한 번도 150% 아래로 내려가지 않았습니다. 자체매입 잔액은 프로그램으로 줄였고 조달 구조는 확정 라인과 담보 조달로 옮겨 놓았습니다. 2023년 6월 특례가 끝나도 NCR은 버팁니다. 그러나 사업장의 사업성은 바뀌지 않았습니다 — 2023년의 위기는 차환이 아니라 사업성에서 옵니다.',
    },
    {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      expected: 113,
      tolerance: 0.05,
      label: '회사채 AA- − 국고 3년 10/14 111~114bp (2009.9 이후 최대)',
    },
    {
      turnId: 't3',
