...
export const t0: T = {
  ...
  events: [
    ...
    },
    {
      ...
      outlet: 'Reuters',
      time: '17:05',
      headline: 'WHO 팬데믹 선언 후 글로벌 증시 불안 — 해외 증거금 대비 필요',
      body: '세계보건기구의 팬데믹 선언 이후 글로벌 증시 불안이 커지고 있다. 한국시간 현재 유럽 거래가 시작됐으며, 오늘 미국 정규장은 아직 열리지 않았다. 전일 미국 종가 기준 S&P 500은 2,741.38이다. 해외장의 추가 하락에 따른 외화 증거금 수요에 대비해야 한다.',
      severity: 'critical',
      sourceRefs: [S.sp500],
      ...
      options: [
        ...
        },
        {
          ...
          expert: {
            rating: 26,
            rationale:
              '업계 대부분이 실제로 택한 경로다. 3월 12일 한국시간 저녁에는 당일 미국 종가와 VIX 75.47을 아직 알 수 없었다. 다만 팬데믹 선언과 전일 해외시장 하락을 근거로 추가 증거금 수요를 준비할 수 있었다. 증거금은 통지를 받은 날 저녁에 납입해야 하므로, 통지를 보고 조달을 시작하면 이미 늦다.',
            historicalNote:
