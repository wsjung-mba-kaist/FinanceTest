      ...
      options: [
        {
          ...
          expert: {
            ...
            historicalNote:
              '진정은 하루뿐이었다. 요청 다음 영업일(11/21) 종가는 1,056.0원까지 되밀렸지만 한 주 만에 다시 밀려 11월 28일 종가는 1,170.0원이었다.',
      ...
      options: [
        {
          ...
          expert: {
            ...
            historicalNote:
              '12월 3일 원/달러 종가는 1,196.0원이었다. 흔히 인용되는 1,240.6원은 같은 날 매매기준율(= 12월 2일 거래의 가중평균)이다.',
            sourceRefs: [S.rate],
          },
