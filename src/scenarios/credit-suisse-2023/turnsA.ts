...
export const t0: T = {
  ...
  events: [
    ...
    },
    {
      ...
      time: '08:00',
      headline:
        '크레디트스위스 연차보고서 공시 — 재무보고 내부통제에 "중대 결함", 감사인 부적정 의견',
      body: '당초 3월 9일 예정이던 2022년 연차보고서가 일주일 늦게 나왔다. 미국 증권거래위원회가 2019·2020년 현금흐름표에 관해 질의한 것이 지연 사유였다. 보고서는 2022년 12월 31일과 2021년 12월 31일 기준 재무보고 내부통제가 유효하지 않다고 결론지었고, 감사인은 내부통제에 대해 부적정 의견을 냈다. 자본비율(CET1 14.1%)과 유동성커버리지비율(144%)은 규제 요건을 충족한다.',
      severity: 'critical',
