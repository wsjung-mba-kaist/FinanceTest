...
지난 나흘 동안 미국에서 두 은행이 문을 닫았습니다. 3월 10일 실리콘밸리은행, 3월 12일 시그니처은행. 오늘 아침에는 크레디트스위스의 2022년 연차보고서가 3월 9일 예정에서 3월 14일로 지연되어 공시되었고, 그 안에 **재무보고 내부통제의 중대 결함**과 감사인의 내부통제 부적정 의견이 들어 있습니다.
...
**핵심 취약점**: 자본이 아니라 예금의 속도. 2022년 4분기에 고객예금 1,380억 프랑이 빠졌고 정기예금의 51%가 한 분기에 사라졌습니다. 2022년 10월 한 달의 실제 유출은 920억 프랑으로, 규제가 30일 스트레스로 상정한 910억과 거의 같았습니다 — **규제 최저기준의 30일치를 한 달에 소진하는 은행**이라는 뜻입니다.`,
    marketBackdrop: `3월 8일 실리콘밸리은행이 채권 210억 달러를 18억 달러 손실로 매각하고 증자를 예고한 뒤 3월 10일 폐쇄되었고, 3월 12일에는 시그니처은행이 문을 닫았습니다. 미 국채 2년물은 3월 8일 5.07%에서 3월 13일 4.03%로 해당 기간 104bp 내렸습니다. 투자등급 회사채 스프레드(Baa − 10년 국채)는 214bp, VIX는 26.5입니다.
  ...
  endings: [
    {
      ...
      title: '월요일 아침 — 인수 합의 이후 영업은 이어졌다',
      narrative:
        '일요일 저녁의 발표가 월요일 아침에 발효했습니다. 결제는 한 번도 멈추지 않았고 예금자는 한 사람도 손실을 보지 않았습니다. 스위스국립은행의 지원은 3월 말 누계 1,680억 프랑까지 갔다가 공적유동성백스톱은 5월 말까지, 추가 유동성지원대출은 8월 말까지 전액 상환되었고, 합병은 6월 12일에 법적으로 완결되었습니다.\n\n남은 것은 세 가지입니다. 주주가 대가를 받는데 AT1이 전액 상각된 순서, 주주총회 결의를 명령으로 생략한 전례, 그리고 서명 가능한 상태로 존재했으나 쓰이지 않은 정리계획입니다. 스위스 의회 조사위원회는 2023년 구성된 뒤 45회 회의와 3만 쪽의 문서 검토를 거쳐 2024년 말 보고서를 냈습니다. AT1 보유자들의 소송은 2025년 10월 연방행정법원의 첫 부분판결로 FINMA의 처분이 취소되었다가 상고심으로 이어졌습니다. 런을 멈추는 것과 그 방식의 정당성을 확보하는 것은 다른 문제입니다.',
    },
    {
